...
Route::put('/files/{imagen}', [App\Http\Controllers\ImageController::class, 'update'])->name('files.update');
Route::delete('/files/{imagen}', [App\Http\Controllers\ImageController::class, 'destroy'])->name('files.destroy');
